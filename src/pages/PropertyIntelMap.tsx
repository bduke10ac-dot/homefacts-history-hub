...
const LAYER_DEFS: Layer[] = [
  ...
  { id: "roof_age", label: "Roof age heatmap", why: "Older roofs in the area predict shared claim cycles.", severity: "info", source: "HomeFacts derived" },
  ...
  { id: "insurance", label: "Insurance risk", why: "Composite of hazard + claims + roof age.", severity: "moderate", source: "HomeFacts derived" },
